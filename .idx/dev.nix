...
{ pkgs, ... }: {
  ...
  env = {
    ...
    POSTGRESQL_CONN_STRING = "postgresql://user:mypassword@localhost:5433/youtube?sslmode=disable";
  };
  ...
  idx = {
    ...
    workspace = {
      ...
      onCreate = {
        default.openFiles = [
          "create.sql" "example.sql" "index.js"
        ];
    ...
    previews = {
      ...
      previews = {
        web = {
          ...
          command = ["npm" "--prefix" "site" "run" "dev" "--" "--port" "$PORT" "--hostname" "0.0.0.0"];
          manager = "web";
          env = {
